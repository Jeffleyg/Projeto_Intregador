    ...
    <div>
      <header className="header">
        ...
        <div className="menu">
          ...
          <ul className="menu-items">
            ...
            <li><a href=".\home">Voltar ao Dashboard</a></li>
      ...
      <div className="container">
        ...
        <form>
          ...
          <select id="tipo_despesa" name="tipo_despesa" required onChange={handleTipoDespesaChange}>
          ...
          <div id="opcoes_transporte" className="opcoes" style={{ display: 'none' }}>
            ...
            <input type="radio" id="outro_transporte" name="meio_transporte" value="outro" onChange={handleMeioTransporteChange} />
            <label htmlFor="outro_transporte">Outro (Especifique):</label>
            <input type="text" id="especificar_outro_transporte" name="especificar_outro_transporte" style={{ display: 'none' }} /><br />
          </div>
