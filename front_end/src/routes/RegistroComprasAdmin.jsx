      ...
      <header className="header">
        ...
        <div className="menu">
          ...
          <ul className="menu-items">
            <li><Link to="/cadastrarDespesasAdmin">Cadastrar despesas</Link></li>
            <li><Link to="/visualizarHistoricoViagemAdmin">Histórico de Compras de Viagem</Link></li>
            <li><Link to="/homeAdmin">Voltar ao Dashboard</Link></li>
